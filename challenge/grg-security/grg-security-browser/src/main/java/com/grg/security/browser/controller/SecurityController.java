package com.grg.security.browser.controller;
...
public class SecurityController {
    ...
    private String HTML_SUFFIX = ".html";
    ...
    public R requireAuthentication(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        return new R(RespCode.UNAUTHORIZED, (Object) "访问的服务需要身份认证，请引导用户到登录页");
    }
